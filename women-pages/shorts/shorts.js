...
function getCardList(data){
        ...
        data.forEach((ele)=>{
            ...
            if(ele.user_category_section=='shorts'){
...
btn.addEventListener('click', ()=>{
	...
	if(high){
		fetchUser(`https://weary-bee-train.cyclic.app/women?user_category_section=shorts&_sort=price&_order=asc`)
	}
	if(low){
		fetchUser(`https://weary-bee-train.cyclic.app/women?user_category_section=shorts&_sort=price&_order=desc`)
	}
})