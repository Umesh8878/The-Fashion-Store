...
btn.addEventListener('click', ()=>{
	...
	if(high){
		fetchUser(`https://weary-bee-train.cyclic.app/women?user_category_section=shoes&_sort=price&_order=asc`)
	}
	if(low){
		fetchUser(`https://weary-bee-train.cyclic.app/women?user_category_section=shoes&_sort=price&_order=desc`)
	}
})