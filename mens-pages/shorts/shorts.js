...
btn.addEventListener('click', ()=>{
	...
	if(high){
		fetchUser(`https://weary-bee-train.cyclic.app/mens?user_category_section=shorts&_sort=price&_order=asc`)
	}
	if(low){
		fetchUser(`https://weary-bee-train.cyclic.app/mens?user_category_section=shorts&_sort=price&_order=desc`)
	}
})